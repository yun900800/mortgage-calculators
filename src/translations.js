...
export const translations = {
    ...
    zh: {
        ...
        newsDesc: "进入2026年，全球主要经济体通胀趋于平稳，利率市场进入高位横盘期。对于购房者而言，LPR（贷款市场报价利率）的微调将直接影响月供压力。建议关注宏观政策调控，利用本工具的提前还贷对比功能，实时测算利率变动对总利息的影响。",
        mathTitle: "等额本金与本息的数学差异",
        mathDesc: "等额本息（EMI）的数学本质是复利现值公式，前期利息比例极高；而等额本金则是线性递减，本金固定，利息随本金减少而缩减。长期看，等额本金能节省 15%-25% 的利息支出，但前期还款压力大。本工具可以帮您直观量化这种利息差。",
        inflationTitle: "为什么通胀时期不建议过快提前还贷？",
        inflationDesc: "通胀是债务人的朋友。在通胀环境下，货币购买力下降，而您的房贷债务是名义固定的。这意味着您在用未来贬值的钱偿还当前的债务。如果您的理财收益率或收入增长率高于贷款利率，保留现金流往往比急于还清贷款更具财务优势。",
