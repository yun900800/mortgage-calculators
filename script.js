...
faqA2: "这取决于您的目标：1. 追求极致省钱：选“缩短年限”。借钱时间缩短，利息节省效果最强。 2. 追求现金流：选“减少月供”。这能直接增加每月的可支配支出，提升生活容错率，适合近期有大开支计划的人群。",
    ...
    ja: {
        ...
        advancedTitle: "繰越返済オプション (高度)",
        lumpSumOption: "一括返済",
        monthlyExtraOption: "毎月の増額",
        repayAmount: "返済額",
...
function showDetailedResults(current, normal, isAdvanced) {
    ...
    if (isAdvanced) {
        ...
        summaryDiv.innerHTML = `
            <div class="save-item">
                <span>${config.totalSaved}:</span>
                <span class="green">${formatCurrency(normalInt - totalInt)}</span>
            </div>
            <div class="save-item">
